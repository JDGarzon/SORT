...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        try (com.zeroc.Ice.Communicator communicator = com.zeroc.Ice.Util.initialize(args, "config.server",
            ...
            com.zeroc.Ice.Object sorterObject = master;
            ...
            setMaster(sorterPrx);
            adapter.activate();
            broker.registerMaster(sorterPrx, receiver);
            launchWorkers();
    ...
    public static void setMaster(MasterPrx masterPrx) {
        master = masterPrx;
    }
